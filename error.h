...
char * Tableau_sx_sm_erreurs[45] = {"'procedure' expected" , "'identifier' expected" , "'is' expected" , "'begin' expected" , "'end'  expected" , "';' expected" , "':' expected" , "',' expected" , "a type is expected " , "')' expected " , "'(' expected" , "a value expected" , "':=' expected " , "'loop' expected" , "'while' expected" , "missing 'for'" , "'in' expected" , "missing or wrong for index type" , "'exit' expected " , "'when' expected" , "'if' expected " , "'then' expected " , "'elsif' expected " , "missing or wrong condition" , "'comparator' expected " , "missing 'when others'" , "'=>' expected " , "'case' expected " , "'-' expected " , "'+' expected " , "'*' expected " , "'/' expected " , "syntactic error" ,"NotDeclared","AlreadyDeclared","NotInitialized","BadlyInitialised","IncompatibleAssignType","IncompatibleCompType",
