...
static char * Tableau_sx_sm_erreurs[45] = {"missing 'procedure'" , "missing 'identifier'" , "missing 'is'" , "missing 'begin'" , "missing 'end'" , "missing ';'" , "missing ':'" , "missing ','" , "missing 'type'" , "missing ')'" , "missing '('" , "missing 'value'" , "missing ':='" , "missing 'loop'" , "missing 'while'" , "missing 'for'" , "missing 'in'" , "missing or wrong for index type" , "missing 'exit'" , "missing 'when'" , "missing 'if'" , "missing 'then'" , "missing 'elsif'" , "missing or wrong condition" , "missing 'comparator'" , "missing 'when others'" , "missing '=>'" , "missing 'case'" , "missing '-'" , "missing '+'" , "missing '*'" , "missing '/'" , "non categorized" ,"NotDeclared","AlreadyDeclared","NotInitialized","BadlyInitialised","IncompatibleAssignType","IncompatibleCompType",
